...
{	
	...
	document.getElementById(data2).readOnly = false;
      ...
      <br>
      <input name="evaluacion1" type="text" id="evaluacion1" placeholder="Evaluación 1" onchange="evaluacion()" value="<?=$dt_calificaciones['0']->evaluacion1;?>" size="20" onchange="evaluacion()" maxlength="3" <? if($on_off['0']->primera_e == 0){echo 'readonly="readonly"';}?>/>
      <br />
      ...
      <br>
      <input name="evaluacion2" type="text" id="evaluacion2" placeholder="Evaluación 2" onchange="evaluacion()" value="<?=$dt_calificaciones['0']->evaluacion2;?>" size="20" onchange="evaluacion()" maxlength="3" <? if($on_off['0']->segunda_e == 0){echo 'readonly="readonly"';}?>/>
      <br />
      ...
      <br>
      <input name="asistencia3" type="text" id="asistencia3" placeholder="Asistencia 3" value="<?=$dt_calificaciones['0']->asistencia3;?>" size="20" onchange="asistencia('asistencia3','evaluacion3'),myFunction('fecha3'),asistencias()" <? if($on_off['0']->tercera_e == 0){echo 'readonly="readonly"';}?>/>
      <br />
...
<div class="large-3 columns">
      ...
      <br>
      <input name="asistencia4" type="text" id="asistencia4" placeholder="Asistencia 4" value="<?=$dt_calificaciones['0']->asistencia4;?>" size="20" onchange="asistencia('asistencia4','evaluacion4'),myFunction('fecha4'),asistencias(),myFunction('fecha')" <? if($on_off['0']->cuarta_e == 0){echo 'readonly="readonly"';}?>/>
      <br />
      
      <label for="Evaluación 4">Evaluación 4:</label>
      <br>
      <input name="evaluacion4" type="text" id="evaluacion4" placeholder="Evaluación 4" onchange="evaluacion()" value="<?=$dt_calificaciones['0']->evaluacion4;?>" size="20" maxlength="4" <? if($on_off['0']->cuarta_e == 0){echo 'readonly="readonly"';}?>/>
      <br />
