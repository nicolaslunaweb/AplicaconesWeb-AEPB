...
<ul class="breadcrumbs">
  ...
  <li class="unavailable"><a href="#">Lista Talleres Profesores</a></li>
</ul>
</div></div>
<!-- breadcrumbs  -->
...
foreach($d_t_profesores as $valor):?>
	<tr>
		...
		<td align='center'><?=anchor('admin/vista_talleres_profesor/'.$valor->clave_docente."/".$valor->IDre, 'Ver Datos','class="small button"')?></td>
	</tr>
<?php endforeach;?>
<?php }?>
</tbody>
