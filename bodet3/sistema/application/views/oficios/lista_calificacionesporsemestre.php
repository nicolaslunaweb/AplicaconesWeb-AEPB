...
<table width="100%" border="1" cellspacing="0" cellpadding="5">
  <tr>
    ...
    <td colspan="<?php if($semestre >= 2){echo "14";}else{echo "12";} ?>" align="center">CALIFICACIÓN DE REGULARIZACIÓN</td>
  ...
  <tr class="chica">
    ...
    <td align="center"><? if($semestre >= 2){echo $this->user->mi_join($pref.$s."7",'materias','clave_especialidad','materia'); }?></td>
    <td align="center">&nbsp;</td>
    <td align="center">&nbsp;</td>
...
foreach($dt_escolaridad as $valor):?>
  <tr>
    ...
    <td><? if($semestre >= 2){echo $this->user->mi_join_m($valor->matricula,$pref.$s."7",'calificaciones','matricula','materia','calificacion_final');}?></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
?>  
<tr>
<td colspan="<?php if($semestre >= 2){echo "26";}else{echo "24";} ?>" align="center">No hay datos! o la consulta esta mal...</td>
</tr>
<?php 
}?>
</table>
