...
{	
	...
	document.getElementById(data2).readOnly = false;
     ...
     <label for="Matricula">Matricula:</label>
      ...
      <br>
      <input name="evaluacion1" type="text" id="evaluacion1" placeholder="Evaluación 1" value="<?=$dt_calificaciones['0']->evaluacion1;?>" size="20" onchange="evaluacion()" maxlength="3"/>
      <br />
      ...
      <br>
      <input name="evaluacion2" type="text" id="evaluacion2" placeholder="Evaluación 2" value="<?=$dt_calificaciones['0']->evaluacion2;?>" size="20" onchange="evaluacion()" maxlength="3"/>
      <br />
      ...
      <br>
      <input name="asistencia3" type="text" id="asistencia3" placeholder="Asistencia 3" value="<?=$dt_calificaciones['0']->asistencia3;?>" size="20" onchange="asistencia('asistencia3','evaluacion3'),myFunction('fecha3'),asistencias(),myFunction('fecha')"/>
      <br />
