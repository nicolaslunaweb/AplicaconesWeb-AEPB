...
<ul class="breadcrumbs">
  ...
  <li class="unavailable"><a href="<?=base_url();?>admin/alta_profesor">Actualización Curricular</a></li>
</ul>
</div></div>
...
<div class="row">
        ...
        <?php echo form_open('admin/sav_talleres_profesor','class="custom"'); ?>
      ...
      <div class="large-4 columns">
      <label for="sedulaprofecional">Cédula Profesional:</label>
      <br>
      <input type="text" size="10" id="sedulaprofecional" name="sedulaprofecional" placeholder="Cédula Profesional"/>
      <br>
