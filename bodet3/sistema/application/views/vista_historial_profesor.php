...
<ul class="breadcrumbs">
  ...
  <li class="unavailable"><a href="#">Vista historial Profesor</a></li>
</ul>
</div></div>
<!-- breadcrumbs  -->
<div class="row">
        ...
        <div class="large-12 columns">
          ...
          <tr>
            ...
            <?php if($dt_historial_prof['0']){ ?>
<table width="800" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td bgcolor="#FFFFFF">Nivel</td>
                    <td colspan="3" bgcolor="#F9F9F9">
					<?
                  switch ($dt_historial_prof['0']->nivel) {
                ...
                case 7: echo "Doctorado"; break;
                  ...
                  <td colspan="3" bgcolor="#F9F9F9"><?=$dt_historial_prof['0']->nombre;?></td>
                </tr>
                <tr>
                  <td bgcolor="#FFFFFF">Institución</td>
                  <td width="428" bgcolor="#F9F9F9"><?=$dt_historial_prof['0']->institucion;?></td>
                </tr>
                <tr>
                  <td bgcolor="#FFFFFF">Titulo</td>
                  <td colspan="3" bgcolor="#F9F9F9"><?=$dt_historial_prof['0']->titulo;?></td>
                </tr>
                <tr>
                  <td bgcolor="#FFFFFF">Horas</td>
                  <td colspan="3" bgcolor="#F9F9F9"><?=$dt_historial_prof['0']->horas;?></td>
                </tr>
                <tr>
                  <td bgcolor="#FFFFFF">Porcentaje de Avance</td>
                  <td colspan="3" bgcolor="#F9F9F9"><?=$dt_historial_prof['0']->porcentaje_de_avance;?></td>
                </tr>
                <tr>
                  <td bgcolor="#FFFFFF">Linea</td>
                  <td colspan="3" bgcolor="#F9F9F9"><?=$dt_historial_prof['0']->linea;?></td>
                </tr>
                <tr>
                  <td bgcolor="#FFFFFF">Temática</td>
                  <td colspan="3" bgcolor="#F9F9F9"><?=$dt_historial_prof['0']->tematica;?></td>
                </tr>
                <tr>
                  <td bgcolor="#FFFFFF">Municipio</td>
                  <td colspan="3" bgcolor="#F9F9F9"><?=$dt_historial_prof['0']->municipio;?></td>
                </tr>
                <tr>
                  <td bgcolor="#FFFFFF">Ciudad</td>
                  <td colspan="3" bgcolor="#F9F9F9"><?=$dt_historial_prof['0']->ciudad;?></td>
                </tr>
                <tr>
                  <td bgcolor="#FFFFFF">Beca</td>
                  <td colspan="3" bgcolor="#F9F9F9">
				  <?
                  switch ($dt_historial_prof['0']->beca) {
                ...
                <tr>
                  ...
                  <td colspan="3" bgcolor="#F9F9F9"><?=$dt_historial_prof['0']->tipo_de_beca;?></td>
                </tr>
                <tr>
                  <td bgcolor="#FFFFFF">Institución que la Otorga</td>
                  <td colspan="3" bgcolor="#F9F9F9"><?=$dt_historial_prof['0']->institucion_que_la_otorga;?></td>
                </tr>
                <tr>
                  <td bgcolor="#FFFFFF">Fecha</td>
                  <td colspan="3" bgcolor="#F9F9F9"><?=$dt_historial_prof['0']->fecha;?></td>
                </tr>

              </table>
              <?php }else{
				  ?>
                  <h4 align="center">No hay registros en Historial de este Academico</h4>
                  <?php } ?>
<br />
<? if($idsession != "2"){ ?>
              <table width="800" style="border:0px;" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="400"></td>
                  <td width="400"><?php echo form_open('admin/edit_historial_profesor','class="custom"'); ?><input name="clave_docente" id="clave_docente" type="hidden" value="<?=$dt_prof['0']->clave_docente;?>" /><input type="submit"  class="button postfix" value=" Editar Perfil del Profesor "/>  </form></td>
                </tr>
              </table>
<? } ?>              
            </td>
