...
<ul class="breadcrumbs">
  ...
  <li class="current"><a href="<?=base_url();?>historial">Historial</a></li>
  <li class="unavailable"><a href="#">Vista historial</a></li>
</ul>
</div></div>
...
<?php }else{echo "<blockquote>No hay Datos Guardados!</blockquote>";}?>
              </td>
            </tr>
          </table>
        </div>
